...
The date in these tests is arbitrary: fee_for_time only reads the
time of day. Weekend and holiday handling is tested separately.
"""


from datetime import datetime

from toll_calculator import fee_for_time
